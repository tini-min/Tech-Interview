...
### 5-3. CPU 스케줄러(단기 스케줄러)의 종류에 대해 설명해 주세요.
...
## 6. 동기와 비동기, Blocking과 Non-Blocking은 무엇인가요?
(참조 https://velog.io/@wonhee010/동기vs비동기-feat.-blocking-vs-non-blocking)
...
### 8-3. 페이지 부재와 페이지 교체에 대해 설명해 주세요.
...
#### 8-4-1. Page Reference String은 무엇인가요?
